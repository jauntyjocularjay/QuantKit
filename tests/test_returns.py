...
def test_return_list():
    ...
    result = return_original_sequence_type(list, (1, 2, 3))
...
def test_return_tuple():
    ...
    result = return_original_sequence_type(tuple, [1, 2, 3])
...
def test_return_set():
    ...
    result = return_original_sequence_type(set, [1, 2, 3, 2])
...
def test_return_str():
    ...
    result = return_original_sequence_type(str, ['a', 'b', 'c'])
...
def test_return_bytes():
    ...
    result = return_original_sequence_type(bytes, [65, 66, 67])
...
def test_return_bytearray():
    ...
    result = return_original_sequence_type(bytearray, [65, 66, 67])
...
def test_return_range():
    ...
    result = return_original_sequence_type(range, [1, 2, 3, 4, 5])
...
def test_return_deque():
    ...
    result = return_original_sequence_type(deque, [1, 2, 3])
...
def test_return_array():
    ...
    result = return_original_sequence_type(Array, [1, 2, 3])
...
def test_return_userlist():
    ...
    result = return_original_sequence_type(UserList, [1, 2, 3])
...
def test_non_sequence_input():
    ...
    with pytest.raises(TypeError):
        return_original_sequence_type(list, 123)

# --- Additional coverage tests ---
def test_range_non_numeric():
    """Should not return range if input is not all numeric."""
    result = return_original_sequence_type(range, ['a', 'b', 'c'])
...
def test_range_empty():
    ...
    result = return_original_sequence_type(range, [])
...
def test_range_single_element():
    ...
    result = return_original_sequence_type(range, [5])
...
def test_fallthrough_branch():
    ...
    class Dummy: pass
    result = return_original_sequence_type(Dummy, [1, 2, 3])
